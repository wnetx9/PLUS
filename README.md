...
# OPÇÃO 2
```
apt update -y && apt upgrade -y && wget -y; bash <(wget -qO- raw.githubusercontent.com/PhoenixxZ2023/PLUS/main/script/arm64/Plus)
...
````
wget https://raw.githubusercontent.com/PhoenixxZ2023/PLUS/main/script/arm64/Plus)
````
